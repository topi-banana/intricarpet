...
#[cfg(not(feature = "since-1.18"))] import me.lntricate.intricarpet.interactions.Interaction;
...
#[cfg(not(feature = "since-1.18"))] import org.spongepowered.asm.mixin.injection.At;
